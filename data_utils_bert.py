    ...
    def __init__(self, fname, tokenizer):
        ...
        for i in range(0, len(lines)):
            ...
            for aspect, polarity in zip(aspect_list, polarity_list):
                ...
                aspects_indices = tokenizer.text_to_sequence(aspects)
                ...
                sdat_graph = idx2graph_sd[graph_id]
                ...
                sdat_graph = np.pad(idx2graph_sd[graph_id], \
                    ((0, tokenizer.max_seq_len - idx2graph_sd[graph_id].shape[0]), (0, tokenizer.max_seq_len - idx2graph_sd[graph_id].shape[0])), 'constant')
                ...
                data = {
                    ...
                    'aspects_indices': aspects_indices,
